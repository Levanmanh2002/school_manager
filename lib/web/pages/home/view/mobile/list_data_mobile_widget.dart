...
class ListDataMobileWidget extends StatefulWidget {
  const ListDataMobileWidget({super.key});

  @override
  State<ListDataMobileWidget> createState() => _ListDataMobileWidgetState();
}

class _ListDataMobileWidgetState extends State<ListDataMobileWidget> with TickerProviderStateMixin {
