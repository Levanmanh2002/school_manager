...
class BarChartCopmponent extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => BarChartCopmponentState();
}

class BarChartCopmponentState extends State<BarChartCopmponent> {
