        ...
        title: Row(
          ...
          children: [
            SvgPicture.asset(
              ...
              width: 24,
              height: 24,
              color: controller.index.value == index ? appTheme.appColor : appTheme.whiteColor,
            ),
              ...
              child: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    buildListTile('Chuyển ngành', IconAssets.tranferIcon, 7, sideBarController),
                    buildListTile('Quyền truy cập', IconAssets.userGearIcon, 8, sideBarController),
                  ],
                ),
              ),
            ),
